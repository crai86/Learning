formModule.directive('uiFormElementCustomImage', ['$compile', 'formService', function($compile, formService){
	...
	//			var temp = '<img src="..." class="img-responsive" alt="Responsive image">';
	//		};
	//
